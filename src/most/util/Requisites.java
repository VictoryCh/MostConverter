...
public class Requisites {
	...
	private static final List<String> REC_NEED_CONVERT = Arrays.asList("Р[1-12-1]", "Р[1-13-1]", "Р[1-13-2]", "Р[1-13.1-1]", "Р[1-13.1-2]", "Р[1-13.1-3]",
			...
			"Р[5-7.1-1]", "Р[5-7.1-2]", "Р[5-7.2-1]", "Р[5-7.2-2]", "Р[5-7.3-1]", "Р[5-7.3-2]", "Р[6-15.1-4]",
			"Р[6-15.2-4]", "Р[6-15.3-4]", "Р[6-15.4-4]", "Р[6-15.5-4]", "Р[6-15.6-4]", "Р[6-15.7-4]", "Р[6-15.8-4]",
			"Р[6-15.9-4]", "Р[6-15.10-4]", "Р[6-17.1-4]", "Р[6-17.2-4]", "Р[6-17.3-4]", "Р[6-17.4-4]", "Р[6-17.5-4]",
			"Р[6-17.6-4]", "Р[6-17.7-4]", "Р[6-17.8-4]", "Р[6-17.9-4]", "Р[6-17.10-4]");
